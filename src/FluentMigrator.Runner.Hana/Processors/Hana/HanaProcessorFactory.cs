...
// ***********************************************************************
// <copyright file="HanaProcessorFactory.cs" company="FluentMigrator Project">
...
namespace FluentMigrator.Runner.Processors.Hana
{
    ...
    public class HanaProcessorFactory : MigrationProcessorFactory
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HanaProcessorFactory"/> class.
        /// </summary>
        [Obsolete]
