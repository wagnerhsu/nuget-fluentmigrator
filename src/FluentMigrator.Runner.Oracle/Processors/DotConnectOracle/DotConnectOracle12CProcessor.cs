...
// ***********************************************************************
// <copyright file="DotConnectOracle12CProcessor.cs" company="FluentMigrator Project">
...
namespace FluentMigrator.Runner.Processors.DotConnectOracle
{
    ...
    /// </summary>
    public class DotConnectOracle12CProcessor : DotConnectOracleProcessor
    {
        /// <summary>
        ...
        /// <inheritdoc />
        public override string DatabaseType => "DotConnectOracle12c";

        /// <inheritdoc />
        public override IList<string> DatabaseTypeAliases { get; } = new List<string>()
            { "DotConnect-Oracle-12c", "DotConnect Oracle 12c", "DotConnect-Oracle12c", "DocConnect Oracle", "Oracle" };
    }
}
